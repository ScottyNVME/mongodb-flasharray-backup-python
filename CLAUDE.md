# Mongo Deployment Project-Specific Copilot Instructions

These instructions are specific to the mongodb-flasharray-backup project and supplement the default repository-wide Copilot instructions.

## Project Overview
This repository contains automation for MongoDB deployment, snapshot orchestration, oplog handling, restore flows, protection group initialization, and cleanup tasks.

## Working Guidelines
- Prefer small, surgical changes to code
- Keep configuration centralized and avoid duplicating settings across scripts
- Preserve script interoperability across snapshot, restore, and oplog workflows
- Validate changes against the intended operational flow before considering work complete
- Use existing naming and scripting conventions consistently across new changes

## Operational Notes
- Of the utmost importance is the correctness of the backup and restore operations
- Changes may affect backup/restore safety and operational recovery workflows
- Be cautious with destructive or cleanup-oriented steps
- Treat snapshot, oplog, and restore scripts as part of a coordinated system rather than isolated utilities

# Agent Operating Rules (Copied from CLAUDE.md)
